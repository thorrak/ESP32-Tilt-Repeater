...
* Converts to continuous scan /w 15 second rebroadcast timeout
* Intelligently screens for the "version" broadcast and treats it separately from the gravity readings
